...
> **`NOTE:`** If the pre-installation is resuming here, ensure the environment variables have been properly set by following [Set reusable environment variables](pre-installation.md#15-set-reusable-environment-variables) and then coming back to this page.
